 ...
 * of Concerto software and systems Pvt. Ltd.(Confidential Information).
 * You shall not disclose such Confidential Information and shall use it
 * only in accordance with the terms of the license agreement you entered
 * with Concerto software and systems Pvt. Ltd.
 * 
 * Copyright (c) 2008 - 2019 by
 * Concerto Software and Systems Pvt. Ltd.
 * Millennium Business Park, Navi Mumbai, 400710, India.
 ******************************************************************************/
/**
 * 
 */
package com.concerto.user_authentication.constant;
...
public class AppConstant {
	...
	public static final String MAIL_USER_STATUS = "mail.user.status";
	public static final String MAIL_RESET_PASSWORD_CHANGE_DATE = "$ChangeDate";
	public static final String MAIL_RESET_PASSWORD_CHANGE_TIME = "$Changetime";
	...
	public static final String CONFIG_DB_PASSWORD = "spring.datasource.password";
	...
	public static final String LOGIN_PARAM_USER_PASSWORD = "j_password";
	...
	public static final String FORGET_PASSWORD_URL = "/validationForForgotPassword.htm";
	...
	public static final String SESSION_USER_LIST = "ALLOWED_USER_LIST";
	...
	public static final String USER_LOGIN_PERMISSION_DAYS = "common.login.permission.days";
	...
	public static final String MAIL_USER_APPLICATION = "$Application";
	...
	public static final String FORGET_PASSWORD_ACTION = "Forgot Password";
	...
	public static final String SESSION_CARDBRAND = "CARDBRAND";
	...
	public static final String SESSION_BROKERID_ALLOWED = "BROKERIDA";
	...
	public static final String partialLinkFlagUnchecked = "N";
	...
	public static final String lINK_TYPE_GUI = "GUI";
	...
	public final static Integer ALERT_NOTIFICATION_ROUTING_CONSTANT_DAY = 7;
	
	public final static String TRAN_PURCHASE = "1";
	public static final String PASSWORD_RESET_AND_LOGOUT_SUCCESSFULY = "Password Reset and Logout Successfuly";
	...
	public static final String Tran_INITIATED = "INITIATED";
	public static final String Tran_Success = "SUCCESS";
	public static final String Tran_Failure = "FAILURE";
	public static final String Tran_TIMEOUT = "TIMEOUT";
	public static final String Tran_PROGRESS= "IN-PROGRESS";
	
	public static final String FILE_FORMATE="Incorrect File format";
	public static final String NETBANK = "NETBANK";
	public static final String UPI = "UPI";
	public static final String WALLET = "WALLET";
	public static final String URL_GET_RECORD = "getDynamicKycDetailsByBusinessType.htm";
	
	public static final String MOB_DEST_CONFIG = "MOB_DEST_CONFIG";
	
	public static final String MAXIMUM_PASSWORD_LENGTH = "MAXIMUMPASSWORDLENGTH";
	public static final String MINIMUM_PASSWORD_LENGTH = "MINIMUMPASSWORDLENGTH";
	public static final String MINIMUMN_SPECIAL_CHARACTERS = "MINIMUMNSPECIALCHARACTERS";
	public static final String MINIMUM_NUMERIC_CHARACTERS = "MINIMUMNUMERICCHARACTERS";
	public static final String MINIMUM_SMALL_CHARACTERS = "MINIMUMSMALLCHARACTERS";
	
	//public static final String MAIL_USER_STATUS = "mail.user.status";
	public static final String PASSWORD_CAHNGED = "(Password Changed Successfully)";
	public static final String MAIL_EXPIRE_DAYS = "$ExpireDays";
	public static final String LOGIN_USER_EXPIRED ="common.user.expired";
